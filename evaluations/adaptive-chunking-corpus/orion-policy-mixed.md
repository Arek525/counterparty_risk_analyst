Syntetyczny dokument policy organizacji Orion. Usługa: obsługa zgłoszeń klientów. Zakres: usługa produkcyjna, trzeci kwartał 2026. Nie zawiera danych rzeczywistych klientów. Zasady należy czytać razem z zastrzeżeniami. Właściciel biznesowy opisuje cel współpracy, rodzaje danych i uprawnienia. Wcześniejsza wersja może dotyczyć innej usługi.

Dostęp uprzywilejowany

- Administratorzy usługi obsługa zgłoszeń klientów muszą używać uwierzytelniania wieloskładnikowego.
...
- Dane klienta należy usunąć w ciągu 30 dni kalendarzowych od zakończenia umowy.
...
- Pierwsze powiadomienie klienta musi nastąpić w ciągu 24 godzin od uzyskania świadomości incydentu.
