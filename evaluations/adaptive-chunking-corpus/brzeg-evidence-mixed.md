Syntetyczny dokument evidence organizacji Brzeg. Usługa: archiwizacja umów. Zakres: usługa produkcyjna, trzeci kwartał 2026. Nie zawiera danych rzeczywistych klientów. Zasady należy czytać razem z zastrzeżeniami. Właściciel biznesowy opisuje cel współpracy, rodzaje danych i uprawnienia. Wcześniejsza wersja może dotyczyć innej usługi.

Dostęp uprzywilejowany

- Administratorzy usługi archiwizacja umów używają uwierzytelniania wieloskładnikowego.
...
- Dane klienta są usuwane w ciągu 45 dni kalendarzowych od zakończenia umowy.
...
- Pierwsze powiadomienie klienta następuje w ciągu 16 godzin od uzyskania świadomości incydentu.
