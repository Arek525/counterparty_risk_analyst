Synthetic Meridian policy document for warehouse analytics. No real organization or customer data. Coverage: production service, 2026-Q3. Rules and qualifications must be read together. The business owner records relationship purpose, data categories and access before assessment. A previous version may describe another service and must not silently replace this version.

Privileged access

- The supplier must use multi-factor authentication when administering the warehouse analytics service.
...
- Customer records must be removed within 14 calendar days of contract termination.
...
- The first customer incident notice must be sent within 8 hours of awareness.
