    ...
    <main className="auth-layout">
      <section className="auth-brand">
        ...
        <div className="auth-brand-copy">
          <h1>Evidence-based decisions.</h1>
          <p>
            Compare counterparty documents with approved policies, trace every
            source, and preserve the full decision history.
          </p>
        </div>
        <span className="auth-footnote">
          Local counterparty risk assessment workspace
        </span>
      </section>
        ...
        <form className="login-card" onSubmit={submit}>
          {meta?.demo_mode && (
            <div className="demo-callout">
              ...
              <span>
                The data is synthetic and results are generated by a clearly
                identified demo adapter.
              </span>
            </div>
          )}
          <p className="eyebrow">Secure access</p>
          <h2>Sign in</h2>
          <p>Select a demo account or enter your session credentials.</p>
